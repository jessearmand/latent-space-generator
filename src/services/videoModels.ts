...
export const CURATED_TEXT_TO_VIDEO_MODELS: ModelConfig[] = [
    ...
    },
    {
        ...
        displayName: 'FLUX 3',
        category: 'text-to-video',
        description: 'Black Forest Labs video generation with audio, up to 20s at 1080p',
        supportsImageInput: false,
        outputType: 'video',
    },
    {
...
export const CURATED_IMAGE_TO_VIDEO_MODELS: ModelConfig[] = [
    ...
    {
        endpointId: 'fal-ai/wan/v2.7/image-to-video',
        displayName: 'Wan 2.7',
        category: 'image-to-video',
        description: 'Wan I2V with optional last frame, prompt expansion, and 2-15s output',
        supportsImageInput: true,
        outputType: 'video',
    },
    {
    ...
    },
    {
        ...
        displayName: 'FLUX 3 I2V',
        category: 'image-to-video',
        description: 'Animate a starting image with audio, up to 20s at 1080p',
        supportsImageInput: true,
        outputType: 'video',
    },
    {
